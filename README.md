...
# 🎮 Withering Realms — Community Edition

**A dark fantasy roguelite where every victory withers the world**
...
Withering Realms is an action roguelite set in a decaying dark fantasy world, where every defeated boss accelerates the spread of the Withering across the realm. Players switch between the Timeless and Withered shards, merge skill trees, and sacrifice fallen heroes to push deeper with each run. This Community Edition is a standalone build delivered as a self-contained package: no storefront required, no additional software needed, ready to play immediately.

This build is for PC players who want a fully self-contained, offline-ready version of Withering Realms without a storefront.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3441990/ss_1d61f31b04d699eeec3659ddc33c86b8cde50440.1920x1080.jpg?t=1788835872" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3441990/ss_a36d53c99e9c508b04735cd97c7e361c0eb2f1e1.1920x1080.jpg?t=1788835872" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3441990/ss_f043ed15e85bd9ee389e0af59ca6a6833129f0d4.1920x1080.jpg?t=1788835872" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, French, German, Spanish, Japanese, Korean, Polish, Portuguese-Brazil, Russian, Simplified Chinese
- **Voiceover:** English
...
- ⚔️ **Roguelite Combat** — Fast hand-drawn action combat with dozens of mini-bosses and unique encounters.
- 🌑 **Shard Switching** — Travel between the Timeless and Withered shards, each with distinct hazards and loot.
- 🌳 **Merging Skill Trees** — Combine and refine skill trees between runs via the Whirl of Souls.
- 💀 **Sacrifice System** — Spend relics of fallen heroes to enable permanent progression.
- 🤝 **Co-op Multiplayer** — LAN or direct connection supported.
- 🖼️ **Hand-Drawn Art** — Fully hand-drawn characters, enemies and environments.
- 📦 **Self-Contained Package** — Standalone build with no storefront or additional software required.
...
| **Processor** | Intel Core i5-4460 or AMD equivalent | Intel Core i7-8700 or AMD Ryzen 5 3600 |
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 950 or AMD Radeon RX 550 | NVIDIA GeForce GTX 1660 or AMD Radeon RX 5600 XT |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\WitheringRealms\Saved`
